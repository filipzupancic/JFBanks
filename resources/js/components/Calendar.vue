  ...
  <div class="py-8 px-4">
    ...
    <div class="lg:grid lg:grid-cols-12 lg:gap-x-16">
      <div class="mt-10 text-center lg:col-start-6 lg:col-end-13 lg:row-start-1 lg:mt-9 xl:col-start-7">
        ...
        <router-link to="/kredit"> <button type="button" class="focus:outline-none mt-8 w-full rounded-md border border-transparent bg-blue-600 py-2 px-4 text-sm font-medium text-white shadow hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Dodaj dogodek</button></router-link>
      </div>
...
const meetings = [
  {
    ...
    time: '',
    datetime: '',
    name: 'Online klic z bančnim svetovalcem',
    imageUrl:
